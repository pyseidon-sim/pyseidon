...
class SpeedStateMachine:
    ...
    def __init__(self, double_p, halve_p, normal_p, transition_chance_interval=7200, factor=2.0):
        ...
        assert sum([double_p, halve_p, normal_p]) <= 1, "Probabilities must sum up to 1!"
