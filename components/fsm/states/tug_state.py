    ...
    def get_state_graph(cls):
        tug_events = [
            ...
            },
            {
                ...
                'src': [TugState.WAITING_AT_RENDEZVOUS, TugState.WAITING_AT_BERTH,
                        TugState.WAITING_AT_MALFUNCTION_LOCATION],
            ...
            {
                'name': 'break_down',
                'src': [TugState.GOING_TO_BERTH, TugState.GOING_TO_WAITING_LOCATION,
                        TugState.GOING_TO_RENDEZVOUS, TugState.TUGGING_IN, TugState.TUGGING_OUT,
                        TugState.IDLE, TugState.WAITING_AT_RENDEZVOUS, TugState.WAITING_AT_BERTH,
                        TugState.WAITING_AT_BERTH],
                'dst': TugState.BROKEN
            },
            {
            ...
            },
            {
                ...
                'src': [TugState.REPLACING_MALFUNCTIONING_TUG, TugState.TUGGING_IN, TugState.TUGGING_OUT],
                'dst': TugState.WAITING_AT_MALFUNCTION_LOCATION
            }
        ]

        return {
            'initial': TugState.IDLE,
            'events': tug_events
        }
