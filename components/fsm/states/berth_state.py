class BerthState:
    ...
    def get_state_graph(cls):
        berth_events = [
            {
                "name": "book",
                "src": BerthState.AVAILABLE,
                "dst": BerthState.WAITING_FOR_VESSEL,
            },
            {
                "name": "process_boat",
                "src": BerthState.WAITING_FOR_VESSEL,
                "dst": BerthState.SERVING_VESSEL,
            },
            {
                "name": "finish_processing",
                "src": BerthState.SERVING_VESSEL,
                "dst": BerthState.AVAILABLE,
            },
        ]

        return {"initial": BerthState.AVAILABLE, "events": berth_events}
