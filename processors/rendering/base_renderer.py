...
class BaseRenderer(BaseProcessor):
    ...
    def paint_vessel(self, painter, x, y, course):
        painter.triangle([
            ...
            x + math.cos(course) * self.VESSEL_TRIANGLE_SIZE, y + math.sin(course) * self.VESSEL_TRIANGLE_SIZE,
            # Lower right vertex of the triangle
            x + math.cos(course - 90) * self.VESSEL_TRIANGLE_SIZE / 2, y + math.sin(course - 90) * self.VESSEL_TRIANGLE_SIZE / 2,
